...
docker run --rm -p 127.0.0.1:3323:3000 \
  ...
  -e PRODUCT_OVERRIDES='{"1":{"name":"Starter Supply Kit","description":"Everything needed for one nervous beginner and one extremely patient customer.","image":"starter-kit.png","price":4.99,"deluxePrice":4.49,"limitPerUser":3,"reviews":[{"text":"The kit made our storefront feel oddly premium.","author":"store-manager"}]},"2":{"name":"Mango Mane Pomade","description":"Sticky enough for dramatic side parts, fruity enough for plausible deniability."},"3":{"name":"Cloudberry Curl Cream","description":"Adds bounce to carts, cousins, and questionable mustaches."}}' \
